/*
 *  Scene_House_Livingroom_Table.h
 *  enigma
 *
...
class Scene_House_Livingroom_Table : public EScene {
public:
   Scene_House_Livingroom_Table(ESceneDirector *lpSceneDirector);
   ~Scene_House_Livingroom_Table();
